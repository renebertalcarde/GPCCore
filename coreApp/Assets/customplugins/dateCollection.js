    ...
    var methods = {
        init: function (options) {
            ...
            var UI = function (obj) {
                ...
                var changeEvent = obj.attr('data-changeevent');

                var data = [];

                var callChangeEvent = function (op) {
                    if (window[changeEvent]) {                        
                        window[changeEvent](op);
                    }
                };
                ...
                var removeItem = function (index) {
                    ...
                    callChangeEvent('removeItem');
                };

                var createItem = function (i, v) {
                    var item = $('<li class="value" />');
