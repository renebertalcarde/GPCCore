...
namespace coreApp
{
    ...
    public static class Cache
    {
        ...
        public static void Update_Tables(bool _settings = false, bool _addr = false, bool _tmsettings = false, bool _tmsettings_effectivities = false, bool _user_accesses = false)
        {
            cachedTables tables = Get_Tables();
            tables.Refresh(_settings, _addr, _tmsettings, _tmsettings_effectivities, _user_accesses);
